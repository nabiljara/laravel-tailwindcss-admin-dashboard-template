<x-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                    ...
                    @foreach ($stations as $station)
                        <li class="me-2" role="presentation">
                            <button
                                ...
                                id="{{$station['station_id_uuid']}}-tab" type="button" role="tab" aria-controls="{{$station['station_id_uuid']}}"
                                aria-selected="false">
        ...
        <div id="tabContentExample">
            ...
            <div class="station-target hidden rounded-lg bg-gray-50 p-4 dark:bg-gray-800" id="{{$station['station_id_uuid']}}" role="tabpanel"
            aria-labelledby="{{$station['station_id_uuid']}}-tab">
            {{-- Acá van todos los elementos para mostrar --}}
            <p class="text-sm text-gray-500 dark:text-gray-400">
                This is some placeholder content the
                <strong class="font-medium text-gray-800 dark:text-white">{{$station['station_name']}} tab's associated
                    content</strong>
                </p>
            </div>
            @endforeach
