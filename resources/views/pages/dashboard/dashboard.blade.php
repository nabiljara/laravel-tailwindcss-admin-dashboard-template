<x-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div
                    ...
                    <div class="grid h-full max-w-lg grid-cols-3 mx-auto">
                        <a href={{ route('dashboard') }}  class="inline-flex flex-col items-center justify-center px-5 rounded-s-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        ...
                        <a href={{ route('map') }} class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        ...
                        <a href="{{ route('profile.show') }}" class="inline-flex flex-col items-center justify-center px-5 rounded-e-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <script>
            ...
            // ALERTAS
            function generarAlerta(titulo, cuerpo, fecha) {
                ...
                mensajeAlerta.innerHTML = '<span class="font-medium">' + titulo + '</span>' + cuerpo + ' el ' + fechaStr;
            ...
            function cargarNotificacion(titulo, cuerpo, fecha) {
            ...
            */
            ...
            form.addEventListener("submit", (event) => {
                ...
                if (document.getElementById(topicoElegido + "_min").value != null) {
